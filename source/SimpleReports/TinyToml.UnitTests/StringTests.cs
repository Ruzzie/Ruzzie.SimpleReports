...
namespace TinyToml.UnitTests
{
    ...
    public class MultilineLiteralStrings
    {
        ...
        //SET LINE ENDINGS IN YOUR EDITOR TO LF INSTEAD OF CRLF
        [Test]
...
'''";
            ...
            value.Should().Be($"The first newline is{Environment.NewLine}trimmed in raw strings.{Environment.NewLine}   All other whitespace{Environment.NewLine}   is preserved.{Environment.NewLine}");
        }
    }
}